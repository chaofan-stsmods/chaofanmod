...
import io.chaofan.sts.chaofanmod.powers.FlammablePower;
...
public class SpiritFireMonster extends AbstractMonster {
    public static final String ID = makeId("monster.SpiritFire");
    ...
    public void takeTurn() {
        switch (nextMove) {
            case INTENT_DEBUFF:
                addToBot(new ApplyPowerAction(AbstractDungeon.player, this, new FlammablePower(AbstractDungeon.player, 1), 1));
