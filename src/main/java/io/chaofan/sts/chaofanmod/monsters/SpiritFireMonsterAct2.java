...
import io.chaofan.sts.chaofanmod.powers.DazzledPower;
import io.chaofan.sts.chaofanmod.powers.SparkPower;

import static io.chaofan.sts.chaofanmod.ChaofanMod.getImagePath;
import static io.chaofan.sts.chaofanmod.ChaofanMod.makeId;

public class SpiritFireMonsterAct2 extends AbstractMonster {
    public static final String ID = makeId("monster.SpiritFireAct2");
    ...
    public SpiritFireMonsterAct2() {
        super(CardCrawlGame.languagePack.getMonsterStrings(ID).NAME, ID, 180, 0, 0, 600, 400, getImagePath("monsters/blank.png"), 0, 0);
    ...
    public void usePreBattleAction() {
        ...
        if (AbstractDungeon.ascensionLevel >= 18) {
            addToBot(new ApplyPowerAction(this, this, new AddFuelPower(this, 2), 2));
        } else {
            addToBot(new ApplyPowerAction(this, this, new AddFuelPower(this, 1), 1));
        }

        addToBot(new ApplyPowerAction(this, this, new SparkPower(this, -1)));
    }
    ...
    public void takeTurn() {
        switch (nextMove) {
            case INTENT_DEBUFF:
                addToBot(new ApplyPowerAction(AbstractDungeon.player, this, new DazzledPower(AbstractDungeon.player, 4), 1));
